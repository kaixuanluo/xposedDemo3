package com.example.myapplication.fakeLocation.ui;
...
import com.example.myapplication.fakeLocation.data.DbHelper;
...
public class AMapActivity extends AppCompatActivity implements AMap.OnMapClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fake_amap);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.fake_menu_map, menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.search:
                ...
                break;
            case R.id.lac:
                View view1 = getLayoutInflater().inflate(R.layout.fake_dialog_lac_cid, null, false);
